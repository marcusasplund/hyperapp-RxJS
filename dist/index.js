...
var actions = {
  add: function (state) { return ({
    count: ++state.count
  }); },
  scheduleAdd: function scheduleAdd (state, _, actions) {
    delayedClicks$.next(actions.add);
  },
  scheduleSub: function scheduleSub (state, _, actions) {
    delayedClicks$.next(actions.sub);
  },
  sub: function (state) { return ({
    count: --state.count
  }); }
};
...
var ShowConsole = function () { return h( 'fieldset', { id: 'console-log-div' },
    logs.map(function (logitem, i) { return createLogNode(logitem, i); })
  ); };
...
var createLogNode = function (logitem, i) { return h( 'div', { class: logitem.type },
